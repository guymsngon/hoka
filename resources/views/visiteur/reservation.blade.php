                ...
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="" data-original-title="Step 1" aria-expanded="false">
                                <span class="round-tab">
                                    <i class="fa fa-folder-o"></i>
                                </span>
                            </a>
                            <h3 class="booking-heading">Choix Trajet</h3>
                        </li>
                        <li role="presentation">
                            ...
                            <h3 class="booking-heading">Info Visiteur</h3>
                        </li>
                        <li role="presentation">
                            ...
                            <h3 class="booking-heading">Info Paiement</h3>
                        </li>
                        <li role="presentation">
                            ...
                            <h3 class="booking-heading">Apperçu</h3>
                        </li>
                    </ul>
                </div>

                <form id="contact_form" action="https://storage.googleapis.com/theme-vessel/hotel-alpha/index.html" enctype="multipart/form-data" method="GET">
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" id="step1">
                            <div class="row">
                                    ...
                                    <div class="search-area-box-2 search-booking-box bg-grey">
                                        <div class="search-contents">
                                            <div class="search-your-rooms">
                                                <h3 class="hidden-xs hidden-sm">Recherche</h3>
                                                <h2 class="hidden-xs hidden-sm">Ton <span>Trajet</span></h2>
                                                <h2 class="hidden-lg hidden-md">Recherche ton <span>Trajet</span></h2>
                                            </div>
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12">
                                    <div class="row">
                                        <div class="col-lg-12"><h3 class="booking-heading-2 black-color">Trajets Disponible</h3></div>
                                        ...
                                        <?php for($i=1;$i<=2;$i++) {?>
                                            <div class="hotel-box">
                                                ...
                                                <div class="detail clearfix">
                                                    ...
                                                    <h3>
                                                        <a href="rooms-details.html">Trajet <?php echo $i ?></a>
                                                    </h3>
                                                    <h5 class="location">
                                                    ...
                                                    <br/>
                                                    <a class="btn btn-sm btn-theme next-step">Choisir trajet</a>
                                                </div>
                                            </div>
                                        <?php }?>
                                        </div>
                            ...
                            <ul class="list-inline pull-right">
                                <li><button type="button" class="btn search-button btn-theme next-step">continuez</button></li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-xs-12 col-md-push-4">
                                    <div class="contact-form sidebar-widget">
                                        <h3 class="booking-heading-2 black-color">Infos Visiteur</h3>
                                        <div class="row mb-30">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-xs-12 col-md-pull-8">
                                    <div class="booling-details-box">
                                        <h3 class="booking-heading-2">Details Trajet</h3>
                                        ...
                                        <ul>
                                            <li>
                                                <span>Date de départ:</span> october 27, 2017
                                            </li>
                                            <li>
                                                <span>Date d'arrivée:</span> october 29, 2017
                                            </li>
                                            <li>
                                                <span>ville de départ:</span> Paris
                                            </li>
                                            <li>
                                                <span>Ville d'arrivée:</span> Douala
                                            </li>
                                            <li>
                                                <span>type de colis:</span>type 1
                                            </li>
                                        </ul>
                        ...
                        <div class="tab-pane" role="tabpanel" id="complete">
                            ...
                            <br/>
                            <ul class="list-inline pull-right">
                                <li><button type="button" class="btn search-button btn-theme next-step">confirmez</button></li>
                            </ul>
                        </div>
                    </div>
                </form>
