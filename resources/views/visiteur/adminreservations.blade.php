...
@section('content')
    ...
    <div class="text-center col-lg-12"> <h3>Réservations</h3></div>
    ...
    <div  class="col-12" >
        ...
        <div  class="col-lg-4 " >
            <div id="menugauche" class="container" >
                ...
                <div class="btn "  style="background-color: dodgerblue">
        ...
        <div class="container">
            <div class="col-lg-8">
                <table class="table table-responsive-lg table-bordered" style="text-align: center; font-size: 10px">
                    <tr>
                        <th class="" style="width: 5px;">Numéro réservation</th>
                        <th style="width: 300px;">Nom client</th>
                        <th style="width: 300px;">Date réservation</th>
                        ...
                        <th style="width: 300px;">Date livraison</th>
                        <th style="width: 300px;">Date de remise</th>
                        <th style="width: 300px;">Type transport</th>
                        <th style="width: 200px;">Statut réservation</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{$reservation->id}}</td>
                        <td>{{$reservation->id}}</td>
                        <td>{{$reservation->id_annonce}}</td>
                        <td>{{$reservation->id_annonce}}</td>
                        <td>{{$reservation->id_annonce}}</td>
                        <td>{{$reservation->id_annonce}}</td>
                        <td>
                            <select>
                                <option value="fr">Non Remis</option>
                                <option value="nl">remis</option>
                                <option value="en">Livré</option>
                            </select>
